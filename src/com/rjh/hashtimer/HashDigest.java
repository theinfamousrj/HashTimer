...
public class HashDigest {
	 ...
	 * @param fileName the name of the file to get the digest of.
	 * @param algorithm the algorithm to use when producing the digest.
	 */
	public void getDigestOfFile(File fileName, String algorithm) {
		...
		try {
			...
			fileToDigest = this.fileUtils.readFileToByteArray(fileName);
		} catch (IOException e) {
